...
class Lesson {
  ...
  DateTime startTime;
  DateTime endTime;
  DateTime originalEndTime; // Used to store the original end time when the lesson is rescheduled by the user
  LessonStatus status;
...
enum LessonStatus {
  ...
  @JsonValue(400)
  archived, // Lesson is in the past and generated by the system when the course is created, not editable and nothing to do with the bill
}
