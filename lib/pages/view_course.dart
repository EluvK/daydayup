  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        DynamicLessonList(title: '未开始课堂', course: course, lessons: notStartedLessons, editable: true),
        Divider(),
        DynamicLessonList(title: '已结束课堂', course: course, lessons: pastLessons, editable: true),
        Divider(),
      ],
    );
  }
